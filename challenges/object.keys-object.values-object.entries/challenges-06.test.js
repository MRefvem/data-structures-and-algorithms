...
// LOOK UP: a method object.values, object.keys, object.entries
...
const hasChildrenValues = (arr, character) => {
  ...
  arr.forEach(value => {
    ...
    if (parentName === character && checkIfParent.length > 0){
      console.log('is parent', character);
      variable = true;
    } else if (parentName === character && checkIfParent.length === 0){
      // console.log('is not parent', false);
      console.log('is not parent', character);
      variable = false;
    }
  })
  return variable;
